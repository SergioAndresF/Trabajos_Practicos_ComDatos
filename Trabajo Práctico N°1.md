...
> Para verificar la conectividad de extremo a extremo, se utilizó la herramienta Command Prompt para ejecutar un comando Ping desde la portátil hacia la computadora de escritorio. Como se observa en la siguiente figura, se enviaron y recibieron 4 paquetes con un 0% de pérdida, confirmando un enrutamiento exitoso entre el segmento inalámbrico y el cableado.
